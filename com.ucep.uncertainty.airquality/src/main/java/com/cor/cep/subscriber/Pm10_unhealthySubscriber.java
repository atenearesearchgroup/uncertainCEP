...
public class Pm10_unhealthySubscriber implements StatementSubscriber{
    ...
    public String getStatement() {
    		...
    		final double P_Pm10_unhealthyRule= 0.98;
	    	...
	    	String Pm10_unhealthyPattern ="@Name('PM10_Unhealthy') "
	    			...
	    			+ " a1.prob *  "
	    			+ "com.cor.cep.util.UBooleans.uAnd(com.cor.cep.util.UReals.ge(a1.value,255.0),com.cor.cep.util.UReals.lt(a1.value,355.0)).getC() * "
	    			+ P_Pm10_unhealthyRule + " as prob\r\n" 
	    			+ "from pattern [every a1 = PM10_Avg(com.cor.cep.util.UBooleans.toBoolean(com.cor.cep.util.UBooleans.uAnd("
	    			+ "com.cor.cep.util.UReals.ge(a1.value,255.0),"
	    			+ "com.cor.cep.util.UReals.lt(a1.value,355.0))))]";
