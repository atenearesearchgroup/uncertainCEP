...
public class Pm2_5_goodSubscriber implements StatementSubscriber{
    ...
    public String getStatement() {
    		...
    		final double P_Pm2_5_goodRule= 0.98;
	    	...
	    	String Pm2_5_goodPattern ="@Name('PM2_5_Good') "
	    			...
	    			+ " a1.prob *  "
	    			+ "com.cor.cep.util.UBooleans.uAnd(com.cor.cep.util.UReals.geZero(a1.value), com.cor.cep.util.UReals.lt(a1.value,12.1)).getC() * "
	    			+ P_Pm2_5_goodRule + " as prob\r\n" 
	    			...
	    			+ "com.cor.cep.util.UReals.lt(a1.value,12.1))))]";
