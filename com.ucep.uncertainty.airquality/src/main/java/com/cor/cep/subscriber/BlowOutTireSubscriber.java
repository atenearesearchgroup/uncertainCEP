...
public class BlowOutTireSubscriber implements StatementSubscriber {
    ...
    public String getStatement() {
	    	...
	    	String BlowOutTirePattern =			"@Name('BlowOutTire') "				
	    			...
	    			+ "  a2 = MotorbikeEvent(a2.tirePressure1 <= 1.2) where timer:within(5 milliseconds)) "
	    			+ "  or "
	    			+ "  (every a1 = MotorbikeEvent(a1.tirePressure2 >= 2.0) -> "
	    			+ "  a2 = MotorbikeEvent(a2.tirePressure2 <= 1.2) where timer:within(5 milliseconds))]";
    ...
    public void update(Map<String, Object> eventMap) {
        ...
        sb.append("\n* " + timestamp + " , " + motorbikeId + " , " + location1 + " , " + pressure1a1 + " , " + pressure1a2 + " , "+ location2 + " , " + pressure2a1 + " , " + pressure2a2);
        sb.append("\n***************************************");
        count++;
