    ...
    public void startSendingRunnerReadings() {
        ...
        xrayExecutor.submit(new Runnable() {
            public void run() {
                ...
                try {
                		fr= new FileReader("inputEvents/marathon_2018_1000_x400.csv");
                		...
                		while((s=br.readLine())!=null) {
                        	...
                        	RunnerEvent ve = new RunnerEvent(point, position, dorsal, name, surname, category, otime, ntime, ntimeseconds);
